...
f.translate(e/2,(c-32)/2);g&&(c=g.width/a,a=g.height/a,128<a&&(c/=a/128,a=128),48<=c&&48<=a&&(f.drawImage(g,c/-2,a/-2,c,a),f.translate(0,a/2+32)));f.fillStyle=t?"white":"black";f.font="28px zen-new";g=b.name||b.short_name||document.title;a=f.measureText(g).width;if(a<.8*e)f.fillText(g,a/-2,0);else for(g=g.split(/\s+/g),a=1;a<=g.length;++a){c=g.slice(0,a).join(" ");var w=f.measureText(c).width;if(a===g.length||w>.6*e)f.fillText(c,w/-2,0),f.translate(0,24*1.2),g.splice(0,a),a=0}return function(){var a=
